  ...
  <div className="max-w-6xl mx-auto relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
      {[
        {
          ...
          desc: "Stay updated with real-time cryptocurrency prices and trends."
        },
        {
          title: "Built for Beginners",
          desc: "Simple UI and clear insights designed for every level."
        },
        {
          title: "Smart Insights",
          desc: "Track key metrics and make better investment decisions."
        }
      ].map((item, i) => (
        <div
          key={i}
      ...
      <section className="px-6 md:px-12 py-24 text-center bg-gray-950">
        ...
        <Link
          to="/prices"
          className="px-10 py-4 rounded-xl bg-indigo-600 hover:bg-indigo-700
